...
DB_ARCHITECT_MODEL = GEMINI_3_5_FLASH  # DB schema generation from blueprint (E7 --provision-db).
SEED_DATA_MODEL = GEMINI_3_5_FLASH     # Seed INSERT generation (E7 --provision-db, dev/staging only).
