...
DEFAULT_LICENSE_HOLDER = "The Authors"

# Full literal Apache 2.0 license appendix notice with {year}/{holder} slots.
APACHE_LICENSE_TEMPLATE = """                                 Apache License
...
def render_apache_license(holder: str = "", year: str = "2026") -> str:
    """Render the canonical Apache 2.0 license text, defaulting an empty holder to DEFAULT_LICENSE_HOLDER."""
