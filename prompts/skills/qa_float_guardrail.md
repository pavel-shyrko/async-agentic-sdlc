...
Rule 3 (Tolerance): Never use exact/strict equality for computed floating-point results. Always apply the language's standard relative/absolute tolerance assertion (e.g., an epsilon or relative-tolerance comparison).
