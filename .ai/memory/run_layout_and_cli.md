---
name: run-layout-and-cli
description: Project-umbrella run-dir layout (runs/<project>/<NNN>_<plane>_<label>_<ts>_<uid>/) + the CLI verbs (--idea / --run / --resume) and how resume routes.
metadata:
  type: reference
---
...
Related: [[workspace-topology]], [[debugging-protocol]].
