...
for the E6 release marker + `initial_budget_usd` for the E7 budget-persistence (the first-invocation ceiling)) — the resume anchor for the whole batch — plus `reports/app_finops_report.json`
